...
///
/// CHAPTER 31 VERSION - running and jumping. Ropes arrive in chapter 32.
///
...
public sealed class HunchRunner
{
    ...
    // ------------------------------------------------------------- ropes -----
    /// <summary>Ropes are added in chapter 32; until then nothing can be grabbed.</summary>
    public bool TryGrab(Rope rope) => false;
