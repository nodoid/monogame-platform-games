...
{
    private __GAME__ _game;
    private UIInterfaceOrientationMask _mask = __MASK__;

    public override UIWindow Window { get; set; }

    public OrientationMode Orientation { get; private set; } = OrientationMode.__MODE__;

    public override bool FinishedLaunching(UIApplication application, NSDictionary launchOptions)
    {
        _game = new __GAME__(this);
        _game.Run();
        return true;
    }
