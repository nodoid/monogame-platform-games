...
{
    private Chapter28.Ch28Game _game;
    private UIInterfaceOrientationMask _mask = UIInterfaceOrientationMask.Landscape;

    public override UIWindow Window { get; set; }

    public OrientationMode Orientation { get; private set; } = OrientationMode.Landscape;

    public override bool FinishedLaunching(UIApplication application, NSDictionary launchOptions)
    {
        _game = new Chapter28.Ch28Game(this);
        _game.Run();
        return true;
    }
