...
///
/// CHAPTER 30 VERSION - running only.
///
/// Acceleration, top speed, friction and turn-around, and nothing else. The
/// jump arrives in chapter 31 and the rope in chapter 32. Run it and hold a
/// direction: the character takes about a fifth of a second to reach top speed
/// and rather longer to stop, and that weight is the whole character.
///
/// In the finished class, where the climber's jump is deliberately rigid, this one is deliberately
...
public sealed class HunchRunner
{
    ...
    public void Update(float dt, InputState input, out bool step, out bool jumped, out bool landed)
    {
        ...
        // The jump arrives in chapter 31.
